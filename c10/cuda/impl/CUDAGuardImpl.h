...
struct CUDAGuardImpl final : public c10::impl::DeviceGuardImplInterface {
  ...
  void createEvent(cudaEvent_t* cuda_event, const EventFlag flag) const {
    ...
    if (C10_UNLIKELY(interp)) {
      interp->trace_gpu<c10::impl::kEventCreation>(reinterpret_cast<uintptr_t>(cuda_event));
    }
  }
  ...
  void destroyEvent(void* event, const DeviceIndex device_index)
    ...
    const c10::impl::PyInterpreter* interp = c10::impl::GPUTrace::get_trace();
    if (C10_UNLIKELY(interp)) {
      interp->trace_gpu<c10::impl::kEventDeletion>(reinterpret_cast<uintptr_t>(cuda_event));
    }
  ...
  void record(
    ...
    *event = cuda_event;
    const c10::impl::PyInterpreter* interp = c10::impl::GPUTrace::get_trace();
    if (C10_UNLIKELY(interp)) {
      interp->trace_gpu<c10::impl::kEventRecord>(
  ...
  void block(void* event, const Stream& stream) const override {
    ...
    const c10::impl::PyInterpreter* interp = c10::impl::GPUTrace::get_trace();
    if (C10_UNLIKELY(interp)) {
      interp->trace_gpu<c10::impl::kEventWait>(
          reinterpret_cast<uintptr_t>(cuda_event),
          reinterpret_cast<uintptr_t>(cuda_stream.stream()));
    }
    setDevice(orig_device);
